...
import 'package:tadabbur/features/journal/widgets/pinned_sheet.dart';
      ...
      body: SafeArea(
        child: RefreshIndicator(
          ...
          child: CustomScrollView(
            ...
            if (_searchQuery.isEmpty &&
                YearInAyatBanner.isInWindow() &&
                allEntries.isNotEmpty)
              SliverToBoxAdapter(
                child: YearInAyatBanner(entries: allEntries),
              ),
        ...
        children: [
          ...
          if (overflow > 0)
            ...
            Material(
              color: Colors.transparent,
              child: InkWell(
                onTap: () => PinnedSheet.show(context, entries, lang, onTap),
